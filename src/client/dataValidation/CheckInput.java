...
public class CheckInput implements InputChecker{
	...
	private void inputMovieGenre() {
	    ...
	    while (true) {
	        ...
	        for (int i = 0; i < Client.genreNames.length; i++) {
	            System.out.println((i + 1) + ". " + Client.genreNames[i]);
	        }
	        ...
	        if (CheckData.isInteger(inputGenre)) {
	            ...
	            if (index >= 0 && index < Client.genreNames.length) {
	                data.put("Genre", Client.genreNames[index].toUpperCase());
	                break;
	            } else {
	        ...
	        for (int i = 0; i < Client.genreNames.length; i++) {
	            if (Client.genreNames[i].equalsIgnoreCase(inputGenre)) {
	                selectedGenre = Client.genreNames[i];
	                break;
	            }
	        }
	...
	private void inputOperatorEye() {
	    ...
	    while (true) {
	        ...
	        for (int i = 0; i < Client.colorNames.length; i++) {
	            System.out.println((i + 1) + ". " + Client.colorNames[i]);
	        }
	        System.out.print("> ");
	        ...
	        if (CheckData.isInteger(inputEye)) {
	            ...
	            if (index >= 0 && index < Client.colorNames.length) {
	                data.put("Operator_Eye",Client.colorNames[index].toUpperCase());
	                break;
	            } else {
	                System.out.println("Ошибка: выбора с таким номером нет в списке.");
	                continue;
	        ...
	        for (String color : Client.colorNames) {
	...
	private void inputOperatorHair() {
	    ...
	    while (true) {
	        ...
	        if (CheckData.isInteger(inputEye)) {
	            int index = Integer.parseInt(inputEye) - 1;
	            if (index >= 0 && index < Client.colorNames.length) {
	                data.put("Operator_Hair",Client.colorNames[index].toUpperCase());
	                break;
	            } else {
	                System.out.println("Ошибка: выбора с таким номером нет в списке.");
	                continue;
	...
	private void inputOperatorNationality(){
	    ...
	    while (true) {
	        ...
	        for (int i = 0; i < Client.countryNames.length; i++) {
	            System.out.println((i + 1) + ". " + Client.countryNames[i]);
	        }
	        ...
	        if (CheckData.isInteger(inputNation)) {
	            ...
	            if (index >= 0 && index < Client.countryNames.length) {
	            	data.put("Operator_Nation",Client.countryNames[index].toUpperCase());
	                break;
	            } else {
	                System.out.println("Ошибка: выбора с таким номером нет в списке.");
	                continue;
	        ...
	        // Проверяем ввод как название через обычный цикл
	        boolean isValid = false;
	        for (String country : Client.countryNames) {
